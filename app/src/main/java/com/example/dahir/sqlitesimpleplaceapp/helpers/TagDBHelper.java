...
import com.example.dahir.sqlitesimpleplaceapp.models.TagsModel;
...
public class TagDBHelper{
    ...
    //add new Categories into the database
    ...
    //check whether the Categories exists or not
    ...
    //count Categoriess from the database
    ...
    //delete Category from the database according to the id
    ...
    //fetch all the Categories title strings from the database
